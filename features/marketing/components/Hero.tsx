...
const Hero = (props: Props) => {
  return (
    <section className="flex justify-center min-h-[calc(100vh_-_64px_-_20vh)] gap-10 flex-col items-center mt-2">
      <div className="bg-[#4A3AFF]/[0.04] z-10 backdrop-blur-md flex items-center w-fit px-14 py-2 text-sm font-medium text-[#080066] rounded-full border border-[#4A3AFF]/[0.07]">
      ...
      <div className="flex z-10 flex-col items-center gap-5">
        ...
        <h2 className="text-slate-600 w-fit text-center max-w-screen-md text-lg/[30px]">
          Stay on top of your finances by logging your daily transactions with
          ease.
        </h2>
      </div>
