...
const HeroRecordTransactionWidget = (props: Props) => {
    return (
        <div className={cn("flex-col items-center z-10 max-w-screen-sm w-full gap-7 flex", props.className)}>
            ...
            <Button className="max-w-[240px] w-full h-14 rounded-full text-lg font-medium">Submit</Button>
        </div>
    );
};
